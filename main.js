...
var author$project$Game$exampleGame = {
	...
	R: 1,
	W: author$project$Game$startingGrid,
	_: 'Dragon',
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					author$project$View$viewCard(gamestate),
					elm$core$Set$toList(gamestate.an))),
				A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
				...
				A2(
					elm$core$List$map,
					author$project$View$viewCard(gamestate),
					elm$core$Set$toList(gamestate.O))),
				A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
				...
				A2(author$project$View$viewCard, gamestate, gamestate._),
				A2(
				elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
				...
				author$project$View$viewBoard(gamestate.W)
			]));
};
